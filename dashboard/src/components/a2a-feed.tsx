...
const TYPE_STYLES: Record<string, string> = {
  ...
  notification: "bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-600",
    ...
    <div className="space-y-1.5 max-h-[400px] overflow-y-auto">
      {messages.map((msg) => {
        ...
        return (
          <div
            key={msg.id}
            className="flex gap-3 p-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-colors"
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 text-xs">
                ...
                <span className="text-gray-300 dark:text-gray-500">&rarr;</span>
